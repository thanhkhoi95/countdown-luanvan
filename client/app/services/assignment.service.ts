...
export class AssignmentService {
    ...
    getByStaff(staff): Observable<any> {
        return this.http.get('/api/assignment/staff?staffId=' + staff.id, this.options);
    }

    getByTable(table): Observable<any> {
        return this.http.get('/api/assignment/table?tableId=' + table.id, this.options);
    }

    addAssignment(assignment): Observable<any> {
        return this.http.post('/api/assignment', assignment, this.options);
    }

    removeAssignment(assignment): Observable<any> {
        return this.http.delete('/api/assignment?id=' + assignment.id, this.options);
    }
